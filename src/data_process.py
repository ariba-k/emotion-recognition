...
# code borrowed from Kaggle
# TODO: optimize code; inefficient as it is
...
for i in tqdm(range(len(df))):
    ...
    if i < 28709:
        if df['emotion'][i] == 0:
            ...
            img.save('./data/train/disgust/im' + str(disgusted) + '.png')
            disgusted += 1
        elif df['emotion'][i] == 2:
            img.save('./data/train/fear/im' + str(fearful) + '.png')
            fearful += 1
        elif df['emotion'][i] == 3:
            ...
            img.save('./data/train/surprise/im' + str(surprised) + '.png')
            surprised += 1
        elif df['emotion'][i] == 6:
    ...
    # test
        ...
        if df['emotion'][i] == 0:
            ...
            img.save('./data/test/disgust/im' + str(disgusted_test) + '.png')
            disgusted_test += 1
        elif df['emotion'][i] == 2:
            img.save('./data/test/fear/im' + str(fearful_test) + '.png')
            fearful_test += 1
        elif df['emotion'][i] == 3:
            ...
            img.save('./data/test/surprise/im' + str(surprised_test) + '.png')
            surprised_test += 1
        elif df['emotion'][i] == 6:
